...
<body>
    ...
    <script>
        ...
        function verif_case(){
            ...
            console.log(tab_2)
            let x = tab_2[0][0].classList
            console.log(tab_2[0][0].classList)
            let prev_1 = (0, 0)
            let prev_2 = (0, 0)
            for (let i =0; i < 9; i++){
                for(let j = 0; j<9; j++){
                    if (tab_2[i][j].classList.contains("selected")){
                        let count = 0
                        if (j<tab_2.length-1 && (tab_2[i][j+1].classList.contains("selected") || tab_2[i][j+1].classList.contains("fixed"))){
                            count++ 
                        }
                        if (i<tab_2.length-1 && (tab_2[i+1][j].classList.contains("selected") || tab_2[i+1][j].classList.contains("fixed"))){
                            count++ 
                        }
                        if ((j<tab_2.length-1 && i<tab_2.length-1) && (tab_2[i+1][j+1].classList.contains("selected") || tab_2[i+1][j+1].classList.contains("fixed"))){
                            count++ 
                        }
                        if (j>0 && (tab_2[i][j-1].classList.contains("selected") || tab_2[i][j-1].classList.contains("fixed"))){
                            count++ 
                        }
                        if (i>0 && (tab_2[i-1][j].classList.contains("selected") || tab_2[i-1][j].classList.contains("fixed"))){
                            count++ 
                        }
                        if ((j>0 && i>0) && (tab_2[i-1][j-1].classList.contains("selected") || tab_2[i-1][j-1].classList.contains("fixed"))){
                            count++ 
                        }
                        if ((j<tab_2.length-1 && i>0) && (tab_2[i-1][j+1].classList.contains("selected") || tab_2[i-1][j+1].classList.contains("fixed"))){
                            count++ 
                        }
                        if ((i<tab_2.length-1 && j>0) && (tab_2[i+1][j-1].classList.contains("selected") || tab_2[i+1][j-1].classList.contains("fixed"))){
                            count++ 
                        }
                        if (count>=3){
                            return false
